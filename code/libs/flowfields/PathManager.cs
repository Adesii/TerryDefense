...
namespace Gamelib.FlowFields {
	public static class PathManager {
		...
		public static Dictionary<int, Pathfinder> _pathfinders = new();
		public static Pathfinder _smallest;
		public static Pathfinder _largest;
		public static Pathfinder _default;
